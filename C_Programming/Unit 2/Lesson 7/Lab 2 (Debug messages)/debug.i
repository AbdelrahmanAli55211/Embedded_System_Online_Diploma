...
void can_send(void)
{
 ...
 if(3>1){ printf("@func: %s ,file: %s ,line: %d ",__func__,".\\debug.c",11); printf(">>\t"); printf("\n");};

}
void can_init(void)
{

 if(3>1){ printf("@func: %s ,file: %s ,line: %d ",__func__,".\\debug.c",17); printf(">>\t"); printf("\n");};

}
int main(void)
{

 if(3>1){ printf("@func: %s ,file: %s ,line: %d ",__func__,".\\debug.c",23); printf(">>\t"); printf("\n");};

 can_init();
 can_send();

 if(3>1){ printf("@func: %s ,file: %s ,line: %d ",__func__,".\\debug.c",28); printf(">>\t"); printf("\n");};
